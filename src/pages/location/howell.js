      ...
      <div id="location" className={styles.container}>
        ...
        <div className={styles.homeBackground}>
          <video autoPlay muted loop playsInline>
            <source src="/images/location/howell.mp4" type="video/mp4" />
        ...
        <div className={styles.workContainer}>
          ...
          <div className={`${styles.phaseContainer} ${styles.phaseContainer1}`}>
            ...
            <div className={styles.phaseRight}>
              <Image
                src={"/images/location/howellPhase1.png"}
          ...
          <div className={`${styles.phaseContainer} ${styles.phaseContainer2}`}>
            <div className={styles.phaseLeft}>
              <Image
                src={"/images/location/howellPhase2.png"}
                className={styles.phaseImage}
                width={600}
                height={600}
                alt="Phase Details"
        ...
        <div className={styles.exampleContainer}>
          ...
          <div className={styles.imageContainer}>
            <Image
              ...
              src={"/images/location/howell1.png"}
              width={400}
              height={500}
              alt="Example Image 1"
            />
            <Image
              className={styles.exampleImage}
              src={"/images/location/howell2.png"}
              width={400}
              height={500}
              alt="Example Image 2"
            />
            <Image
              className={styles.exampleImage}
              src={"/images/location/howell3.png"}
              width={400}
              height={500}
              alt="Example Image 3"
            />
